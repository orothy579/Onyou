        ...
        slivers: [
          SliverAppBar(
                  ...
                  return
                    GestureDetector(
                      ...
                      children: [
                        ...
                        Positioned(
                            right:0, top:0,
                            child: AppIcon(icon: Icons.circle, size: 20, iconColor: Colors.transparent, backgroundColor: mainGreen,)):
                        Container(),
                        Get.find<PopularProductController>().totalItems >=1?
                        Positioned(
                            right:3, top:3,
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                child: Center(child: BigText(size:Dimensions.font26, text:product.name.toString())),
